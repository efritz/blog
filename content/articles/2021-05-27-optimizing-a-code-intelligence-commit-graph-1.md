...
{{< lightbox
  src="/images/external/opt-commitgraph/graph1.png"
  alt="Sample commit graph"
  anchor="feature-branch"
  caption="A Git commit graph with mainline branch main and a feature branch x." >}}
...
{{< lightbox
  src="/images/external/opt-commitgraph/fast.png"
  alt="Fast query plan"
  anchor="query-plan-fast"
  caption="Query plan of a commit graph traversal visiting 10 commits." >}}
...
{{< lightbox
  src="/images/external/opt-commitgraph/slow.png"
  alt="Slow query plan"
...
{{< lightbox
  src="/images/external/opt-commitgraph/graph2.png"
  alt="Sample commit graph"
  anchor="serial-merges"
  caption="A Git commit graph with feature branches x and y merged into main." >}}
...
{{< lightbox
  src="/images/external/opt-commitgraph/super-fast.png"
  alt="Super fast query plan"
  anchor="query-plan-super-fast"
