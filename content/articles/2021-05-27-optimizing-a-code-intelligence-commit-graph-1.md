...
{{< img src="/images/external/shared/precise-xrepo-j2d.gif" alt="Cross-repository jump to definition" caption="Cross-repository jump to definition from a use in `sourcegraph/sourcegraph` to a definition in `gorilla/mux`." >}}
...
{{< img src="/images/external/opt-commitgraph/graph1.png" alt="Sample commit graph" caption="A Git commit graph with mainline branch `main` and a feature branch `x`." >}}
...
{{< img src="/images/external/opt-commitgraph/fast.png" alt="Fast query plan" caption="Query plan of a commit graph traversal visiting 10 commits. Diagram produced from Alex Tatiyants' [Postgres Explain Visualizer](https://github.com/AlexTatiyants/pev)." >}}
...
{{< img src="/images/external/opt-commitgraph/slow.png" alt="Slow query plan" caption="Query plan of a commit graph traversal visiting 100 commits." >}}
...
{{< img src="/images/external/opt-commitgraph/graph2.png" alt="Sample commit graph" caption="A Git commit graph with feature branches `x` and `y` merged into `main`." >}}
...
{{< img src="https://user-images.githubusercontent.com/1387653/66709486-a9813900-ed22-11e9-9519-d9a9c098b37d.png" absolute="true" alt="Query latency comparison" caption="Comparison of latencies between different Git commit graph traversal queries in PostgreSQL." >}}
...
{{< img src="/images/external/opt-commitgraph/super-fast.png" alt="Super fast query plan" caption="Query plan of an optimized commit graph traversal visiting 100 commits." >}}
