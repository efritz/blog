...
{{< hero 
    src="/images/external/opt-indexer/hero.png"
>}}
...
{{< lightbox src="/images/external/opt-indexer/ast.svg" alt="Go AST" >}}
...
<!-- TODO: make local -->
{{< lightbox src="https://i.imgflip.com/4bwccv.jpg" absolute="true" alt="All my idle cores" >}}
...
{{< lightbox src="/images/external/opt-indexer/parallel.svg" alt="Parallelism diagram" >}}
...
{{< lightbox src="/images/external/opt-indexer/perf-1.png" alt="performance comparison" >}}
...
{{< lightbox src="/images/external/opt-indexer/perf-2.png" alt="performance comparison" >}}
