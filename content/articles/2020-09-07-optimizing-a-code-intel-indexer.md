...
{{< lightbox
    src="/images/external/opt-indexer/ast.svg"
    alt="Go AST"
    anchor="ast" >}}
...
{{< lightbox
    src="/images/external/opt-indexer/parallel.svg"
...
{{< lightbox
    src="/images/external/opt-indexer/perf-1.png"
...
{{< lightbox
    src="/images/external/opt-indexer/perf-2.png"
    alt="performance comparison"
    anchor="perf-top" >}}
