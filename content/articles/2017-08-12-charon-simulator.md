...
The solution we settled on was to extend the sliding windows into layers called *tiers*. If a user hits a limit in one tier, it can burst up into the next one. Each tier can be configured independently with the following parameters:
...
<a href="/charon-simulator?tiers=5,1,30,0&name=Simple" target="_blank_">Run the Simulator</a>
...
<a href="/charon-simulator?tiers=5,1,1,0,50,5,5,15&name=Penalties" target="_blank_">Run the Simulator</a>
...
<a href="/charon-simulator?tiers=5,1,1,0,1,15,15,0&name=Punishment" target="_blank_">Run the Simulator</a>
...
<a href="/charon-simulator?tiers=50,60,60,3540&name=Batch Processing" target="_blank_">Run the Simulator</a>
