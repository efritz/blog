...
{{< img src="/images/external/opt-commitgraph/graph6.png" alt="High-merge commit graph" caption="A Git commit graph with a large number of paths from `a` to `g` and `g` to `m`." >}}
...
{{< img src="/images/external/opt-commitgraph/graph7.png" alt="Flat commit graph" caption="A Git commit graph with large distances between code intelligence indexes." >}}
...
{{< img src="/images/external/opt-commitgraph/graph3.png" alt="Sample commit graph" caption="A Git commit graph with code intelligence indexes attached to commits `80c800`, `c85b4b`, and `3daedb`." >}}
...
{{< img src="/images/external/opt-commitgraph/graph4.png" alt="Sample commit graph" caption="A Git commit graph with code intelligence indexes rooted at different subdirectories." >}}
...
{{< img src="/images/external/opt-commitgraph/oom.png" alt="Worker OOM" caption="Worker memory usage exploding, then falling suddenly after the process crashes." >}}
...
{{< img src="/images/external/opt-commitgraph/graph5.png" alt="Sample commit graph" caption="A Git commit graph with code intelligence attached to commits `68acd3` and `67e0bf`." >}}
...
{{< img src="/images/external/opt-commitgraph/cpu-mem-fix.png" alt="CPU and memory reduction" caption="CPU and memory usage drastically after skipping calculation of visible uploads for _trivial_ commits." >}}
...
{{< img src="/images/external/opt-commitgraph/full-disk.png" alt="Critical db size" caption="Sorry about your disk." >}}
