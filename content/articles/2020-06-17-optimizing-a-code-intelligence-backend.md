...
{{< lightbox
  src="/images/external/opt-backend/3.16-cpu.png"
  alt="3.16 CPU"
  caption="CPU"
  anchor="original-3.16-cpu" >}}

{{< lightbox
  src="/images/external/opt-backend/3.16-allocs.png"
  alt="3.16 allocs"
  caption="Memory allocations"
  anchor="original-3.16-mem" >}}

{{< lightbox
  src="/images/external/opt-backend/3.16-heap.png"
  alt="3.16 heap"
  caption="Heap"
  anchor="original-3.16-heap" >}}
...
{{< lightbox
  src="/images/external/opt-backend/precise-code-intel-arch-before-rewrite.svg"
  alt="architecture diagram (before)"
  anchor="arch-before" >}}
...
{{< lightbox
  src="/images/external/opt-backend/precise-code-intel-arch-after-rewrite.svg"
  alt="architecture diagram (after)"
  anchor="arch-after" >}}
...
{{< lightbox
  src="/images/external/opt-backend/lsif-pipeline.png"
  alt="concurrency diagram"
  anchor="linear-pipeline" >}}
...
{{< lightbox
  src="/images/external/opt-backend/lsif-reader-parallelism.png"
  alt="concurrency diagram"
...
{{< lightbox
  src="/images/external/opt-backend/lsif-writer-concurrency-before.png"
  alt="concurrency diagram (before)"
  anchor="concurrency-before" >}}
...
{{< lightbox
  src="/images/external/opt-backend/lsif-writer-concurrency-after.png"
  alt="concurrency diagram (after)"
...
<div class="row">
    ...
    <div class="col-lg-6">
        {{< lightbox
          src="/images/external/opt-backend/3.17-cpu.png"
          alt="3.17 cpu"
          caption="3.17 CPU"
          anchor="3.17-cpu">}}
    </div>
    ...
    <div class="col-lg-6">
        {{< lightbox
          src="/images/external/opt-backend/3.17-allocs.png"
          alt="3.17 allocs"
          caption="3.17 Allocs"
          anchor="3.17-allocs" >}}
    </div>
    ...
    <div class="col-lg-6">
        {{< lightbox
          src="/images/external/opt-backend/3.17-heap.png"
          alt="3.17 heap"
          caption="3.17 Heap"
          anchor="3.17-heap" >}}
    </div>
