...
{{< img src="/images/external/shared/precise-xrepo-j2d.gif" alt="Cross-repository jump to definition" >}}
...
{{< img src="/images/external/opt-backend/3.16-cpu.png" alt="3.16 CPU" caption="CPU" >}}
{{< img src="/images/external/opt-backend/3.16-allocs.png" alt="3.16 allocs" caption="Memory allocations" >}}
{{< img src="/images/external/opt-backend/3.16-heap.png" alt="3.16 heap" caption="Heap" >}}
...
{{< img src="/images/external/opt-backend/precise-code-intel-arch-before-rewrite.svg" alt="architecture diagram (before)" >}}
...
{{< img src="/images/external/opt-backend/precise-code-intel-arch-after-rewrite.svg" alt="architecture diagram (after)" >}}
...
{{< img src="/images/external/opt-backend/lsif-pipeline.png" alt="concurrency diagram" >}}
...
{{< img src="/images/external/opt-backend/lsif-reader-parallelism.png" alt="concurrency diagram" >}}
...
{{< img src="/images/external/opt-backend/lsif-writer-concurrency-before.png" alt="concurrency diagram (before)" >}}
...
{{< img src="/images/external/opt-backend/lsif-writer-concurrency-after.png" alt="concurrency diagram (after)" >}}
...
{{< img src="/images/external/opt-backend/lsif-query-latency-317.png" alt="Precise code intel query latency chart" >}}

This next chart shows the time required to upload and process the indexes.

{{< img src="/images/external/opt-backend/lsif-processing-latency-317.png" alt="Precise code intel index processing latency chart" >}}

These last charts show the size of the converted bundle on disk after conversion.

<div class="text-center benchmark-results">
  {{< img src="/images/external/opt-backend/tidb-bundle-size.png" alt="tidb bundle process code intel bundle (processed index) size on disk chart" >}}
  {{< img src="/images/external/opt-backend/etcd-bundle-size.png" alt="etcd bundle process code intel bundle (processed index) size on disk chart" >}}
  <br />
  {{< img src="/images/external/opt-backend/titan-bundle-size.png" alt="titan bundle process code intel bundle (processed index) size on disk chart" >}}
  {{< img src="/images/external/opt-backend/zap-bundle-size.png" alt="zap bundle process code intel bundle (processed index) size on disk chart" >}}
</div>
...
<div class="row">
    ...
    <div class="col-lg-6">
        {{< img src="/images/external/opt-backend/3.16-cpu.png" alt="3.16 cpu" caption="3.16 CPU" >}}
    </div>
    <div class="col-lg-6">
        {{< img src="/images/external/opt-backend/3.17-cpu.png" alt="3.17 cpu" caption="3.17 CPU" >}}
    </div>
    <h3 class="text-center">Comparing Allocs</h3>
    <div class="col-lg-6">
        {{< img src="/images/external/opt-backend/3.16-allocs.png" alt="3.16 allocs" caption="3.16 Allocs" >}}
    </div>
    <div class="col-lg-6">
        {{< img src="/images/external/opt-backend/3.17-allocs.png" alt="3.17 allocs" caption="3.17 Allocs" >}}
    </div>
    <h3 class="text-center">Comparing Heap</h3>
    <div class="col-lg-6">
        {{< img src="/images/external/opt-backend/3.16-heap.png" alt="3.16 heap" caption="3.16 Heap" >}}
    </div>
    <div class="col-lg-6">
        {{< img src="/images/external/opt-backend/3.17-heap.png" alt="3.17 heap" caption="3.17 Heap" >}}
    </div>
</div>
