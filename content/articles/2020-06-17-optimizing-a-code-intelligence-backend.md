...
{{< hero
  src="/images/external/opt-backend/hero.png"
  headline="Read about how we used a memory and CPU profiler, creative thinking, and a lot of developer elbow grease to optimize our semantic code indexing system to give users twice-as-fast tooltips, go-to-definition, and references."
>}}
...
{{< lightbox src="/images/external/shared/precise-xrepo-j2d.gif" alt="Cross-repository jump to definition" >}}
...
{{< lightbox src="/images/external/opt-backend/3.16-cpu.png" alt="3.16 CPU" caption="CPU" >}}
{{< lightbox src="/images/external/opt-backend/3.16-allocs.png" alt="3.16 allocs" caption="Memory allocations" >}}
{{< lightbox src="/images/external/opt-backend/3.16-heap.png" alt="3.16 heap" caption="Heap" >}}
...
{{< lightbox src="/images/external/opt-backend/precise-code-intel-arch-before-rewrite.svg" alt="architecture diagram (before)" >}}
...
{{< lightbox src="/images/external/opt-backend/precise-code-intel-arch-after-rewrite.svg" alt="architecture diagram (after)" >}}
...
{{< lightbox src="/images/external/opt-backend/lsif-pipeline.png" alt="concurrency diagram" >}}
...
{{< lightbox src="/images/external/opt-backend/lsif-reader-parallelism.png" alt="concurrency diagram" >}}
...
{{< lightbox src="/images/external/opt-backend/lsif-writer-concurrency-before.png" alt="concurrency diagram (before)" >}}
...
{{< lightbox src="/images/external/opt-backend/lsif-writer-concurrency-after.png" alt="concurrency diagram (after)" >}}
...
{{< lightbox src="/images/external/opt-backend/lsif-query-latency-317.png" alt="Precise code intel query latency chart" >}}

This next chart shows the time required to upload and process the indexes.

{{< lightbox src="/images/external/opt-backend/lsif-processing-latency-317.png" alt="Precise code intel index processing latency chart" >}}

These last charts show the size of the converted bundle on disk after conversion.

<div class="text-center benchmark-results">
  {{< lightbox src="/images/external/opt-backend/tidb-bundle-size.png" alt="tidb bundle process code intel bundle (processed index) size on disk chart" >}}
  {{< lightbox src="/images/external/opt-backend/etcd-bundle-size.png" alt="etcd bundle process code intel bundle (processed index) size on disk chart" >}}
  <br />
  {{< lightbox src="/images/external/opt-backend/titan-bundle-size.png" alt="titan bundle process code intel bundle (processed index) size on disk chart" >}}
  {{< lightbox src="/images/external/opt-backend/zap-bundle-size.png" alt="zap bundle process code intel bundle (processed index) size on disk chart" >}}
</div>
...
<div class="row">
    <h3 class="text-center">Comparing CPU</h3>
    <div class="col-lg-6">
        {{< lightbox src="/images/external/opt-backend/3.16-cpu.png" alt="3.16 cpu" caption="3.16 CPU" >}}
    </div>
    <div class="col-lg-6">
        {{< lightbox src="/images/external/opt-backend/3.17-cpu.png" alt="3.17 cpu" caption="3.17 CPU" >}}
    </div>
    <h3 class="text-center">Comparing Allocs</h3>
    <div class="col-lg-6">
        {{< lightbox src="/images/external/opt-backend/3.16-allocs.png" alt="3.16 allocs" caption="3.16 Allocs" >}}
    </div>
    <div class="col-lg-6">
        {{< lightbox src="/images/external/opt-backend/3.17-allocs.png" alt="3.17 allocs" caption="3.17 Allocs" >}}
    </div>
    <h3 class="text-center">Comparing Heap</h3>
    <div class="col-lg-6">
        {{< lightbox src="/images/external/opt-backend/3.16-heap.png" alt="3.16 heap" caption="3.16 Heap" >}}
    </div>
    <div class="col-lg-6">
        {{< lightbox src="/images/external/opt-backend/3.17-heap.png" alt="3.17 heap" caption="3.17 Heap" >}}
    </div>
</div>
