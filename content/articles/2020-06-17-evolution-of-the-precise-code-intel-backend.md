+++
title = "Evolution of the code intelligence backend"
slug = "lsif-backend-evolution"
date = "2020-06-17"
showpagemeta = true
...
{{< hero
    src="/images/external/evolution/hero.png"
    headline="We've spent a year building out the world's largest semantic code index using the Language Server Index Format (LSIF). Read about the technical journey, from MVP to scaling and optimizing the system to support large-scale codebases."
>}}
...
{{< lightbox src="/images/external/evolution/precise-j2d-find-refs.gif" alt="Precise jump to definition and find refs" >}}
...
{{< lightbox src="/images/external/evolution/arch-1.png" alt="architecture diagram" >}}
...
{{< lightbox src="/images/external/evolution/arch-2.png" alt="architecture diagram" >}}
...
{{< lightbox src="/images/external/evolution/arch-3.png" alt="architecture diagram" >}}
...
{{< lightbox src="/images/external/evolution/arch-4.png" alt="architecture diagram" >}}
...
{{< lightbox src="/images/external/evolution/arch-5.png" alt="architecture diagram" >}}
...
{{< lightbox src="/images/external/evolution/arch-6.png" alt="architecture diagram" >}}
...
{{< lightbox src="/images/external/evolution/arch-7.png" alt="architecture diagram" >}}
...
{{< lightbox src="/images/external/evolution/arch-8.png" alt="architecture diagram" >}}
