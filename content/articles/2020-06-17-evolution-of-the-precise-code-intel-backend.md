...
{{< lightbox
    src="/images/external/evolution/precise-j2d-find-refs.gif"
...
{{< lightbox
    src="/images/external/evolution/arch-1.png"
...
{{< lightbox
    src="/images/external/evolution/arch-2.png"
    alt="architecture diagram"
    anchor="async" >}}
...
{{< lightbox
    src="/images/external/evolution/arch-3.png"
    alt="architecture diagram"
    anchor="xrepo" >}}
...
{{< lightbox
    src="/images/external/evolution/arch-4.png"
    alt="architecture diagram"
    anchor="postgres" >}}
...
{{< lightbox
    src="/images/external/evolution/arch-6.png"
    alt="architecture diagram"
...
{{< lightbox
    src="/images/external/evolution/arch-7.png"
    alt="architecture diagram"
    anchor="bundle-manager" >}}
...
{{< lightbox
    src="/images/external/evolution/arch-8.png"
    alt="architecture diagram"
    anchor="removing-lsif-server" >}}
